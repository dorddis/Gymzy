...
const runTests = async () => {
    ...
    assertIncludes(response11_1, `Okay, I'll look up information for "bench press"`, "Test 11.1: GET_EXERCISE_INFO response");
    ...
    assertIncludes(response11_2, `Okay, I'll look up information for "proper deadlift"`, "Test 11.2: GET_EXERCISE_INFO with 'proper deadlift'");
    ...
    let response11_3 = await agent11.processMessage('what is squats', 'test-session-11');
    assertIncludes(response11_3, `Okay, I'll look up information for "squats"`, "Test 11.3: GET_EXERCISE_INFO for squats");
    ...
    assertEqual((_11 = (_10 = agent11.getMemory().workingMemory.userIntent) === null || _10 === void 0 ? void 0 : _10.slots) === null || _11 === void 0 ? void 0 : _11.exercise_name, 'squats', "Test 11.3: Slot 'exercise_name' for squats");
