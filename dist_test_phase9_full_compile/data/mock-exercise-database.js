...
exports.findExercise = exports.mockExerciseDatabase = void 0;
exports.mockExerciseDatabase = [
    {
        id: 'bench_press',
        name: 'Bench Press',
...
const findExercise = (name) => {
    ...
    return exports.mockExerciseDatabase.find(ex => ex.name.toLowerCase() === lowerCaseName || ex.id === lowerCaseName);
};
